...
void
update_positions (std::vector<Position> &positions,
                  std::vector<EntityType> &types)
{
...
void
render_sprites (const std::vector<Position> &positions,
...
void
update_entity_position (std::vector<Position> &positions, unsigned entity_id,
                        Position new_pos)
{
